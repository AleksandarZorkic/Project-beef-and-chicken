        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosesNextDay = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FastFoodWorkTimes", x => x.Id);
                    table.CheckConstraint("CK_FastFoodWorkTime_DayOfWeek_Range", "\"DayOfWeek\" BETWEEN 0 AND 6");
                    table.CheckConstraint("CK_FastFoodWorkTime_TimeRange", "\"IsClosed\" = TRUE OR (\"OpenTime\" <> \"CloseTime\" AND ((\"ClosesNextDay\" = FALSE AND \"OpenTime\" < \"CloseTime\") OR (\"ClosesNextDay\" = TRUE  AND \"OpenTime\" > \"CloseTime\")))");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EmployeeWorkTime_TimeRange", "\"IsOffDay\" = TRUE OR \"StartTime\" < \"EndTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllergenId = table.Column<int>(type: "integer", nullable: false),
                    IsTrace = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryHouseNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    DeliveryPostalCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    DeliveryCity = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkTimes_UserId_DayOfWeek",
                table: "EmployeeWorkTimes",
                columns: new[] { "UserId", "DayOfWeek" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FastFoodWorkTimes_DayOfWeek",
                table: "FastFoodWorkTimes",
                column: "DayOfWeek",
                unique: true);
